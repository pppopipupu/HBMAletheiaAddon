...
public class TileEntityAMSLimiter extends TileEntityMachineBase
    implements IGUIProvider, IEnergyReceiverMK2, IFluidStandardTransceiverMK2 {
    ...
    public DirPos[] getPowerPos() {
        ...
        return new DirPos[] { new DirPos(xCoord, yCoord, zCoord, dir.getOpposite()) };
    }
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        ...
        if (i == 2) return itemstack.getItem() == AletheiaItems.ams_focus_limiter
            || itemstack.getItem() == AletheiaItems.ams_focus_booster;
