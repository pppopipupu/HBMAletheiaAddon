...
public class AletheiaItems {
    ...
    public static void init() {
        bucket_qgp = new ItemQGPBucket(AletheiaBlocks.qgp_block).setUnlocalizedName("bucket_qgp").setContainerItem(Items.bucket);
        GameRegistry.registerItem(bucket_qgp, "bucket_qgp");
        FluidContainerRegistry.registerContainer(new FluidContainer(new ItemStack(bucket_qgp), new ItemStack(Items.bucket), Aletheia.fluid_qgp, 1000));

        qgp_mining_bomb = new ItemQGPMiningBomb(4).setUnlocalizedName("qgp_mining_bomb").setTextureName("tnt_side");
        GameRegistry.registerItem(qgp_mining_bomb, "qgp_mining_bomb");

        upgrade_ultimate = new ItemMachineUpgrade(UpgradeType.OVERDRIVE, 2)
            .setUnlocalizedName("upgrade_ultimate")
            .setTextureName("hbm:upgrade_overdrive_3");
        GameRegistry.registerItem(upgrade_ultimate, "upgrade_ultimate");

        ams_muzzle = new Item().setUnlocalizedName("ams_muzzle").setTextureName("aletheia:ams_muzzle");
        GameRegistry.registerItem(ams_muzzle, "ams_muzzle");

        ams_focus_blank = new Item().setUnlocalizedName("ams_focus_blank").setTextureName("aletheia:ams_focus_blank");
        GameRegistry.registerItem(ams_focus_blank, "ams_focus_blank");

        ams_focus_limiter = new Item().setUnlocalizedName("ams_focus_limiter").setTextureName("aletheia:ams_focus_limiter");
        GameRegistry.registerItem(ams_focus_limiter, "ams_focus_limiter");

        ams_focus_booster = new Item().setUnlocalizedName("ams_focus_booster").setTextureName("aletheia:ams_focus_booster");
            ...
            new GunConfig()
                ...
                .rec(new Receiver(0)
                        ...
                        .mag(new MagazineFullReload(0, 250)
                            .addConfigs(Aletheia.energy_pppop, 
                                        Aletheia.energy_pppop_steel))
                        ...
                        .fire((itemStack, lambdaContext) -> {
                            ...
                            String snd = (currentBullet == Aletheia.energy_pppop) ? "aletheia:weapon.zomgShoot" : "aletheia:weapon.osiprShoot";
                ...
                .orchestra(Orchestras.ORCHESTRA_LASER_PISTOL)
        ).setUnlocalizedName("gun_pppop").setTextureName("aletheia:gun_pppop");
        GameRegistry.registerItem(gun_pppop, "gun_pppop");

        disperser_canister_empty = new Item().setUnlocalizedName("disperser_canister_empty").setCreativeTab(MainRegistry.weaponTab).setTextureName("hbm:disperser_canister");
        GameRegistry.registerItem(disperser_canister_empty, "disperser_canister_empty");

        disperser_canister = new ItemDisperser().setUnlocalizedName("disperser_canister").setContainerItem(disperser_canister_empty).setCreativeTab(MainRegistry.weaponTab).setTextureName("hbm:disperser_canister");
        GameRegistry.registerItem(disperser_canister, "disperser_canister");

        glyphid_gland_empty = new Item().setUnlocalizedName("glyphid_gland_empty").setCreativeTab(MainRegistry.weaponTab).setTextureName("hbm:glyphid_gland");
        GameRegistry.registerItem(glyphid_gland_empty, "glyphid_gland_empty");

        glyphid_gland = new ItemDisperser().setUnlocalizedName("glyphid_gland").setContainerItem(glyphid_gland_empty).setCreativeTab(MainRegistry.weaponTab).setTextureName("hbm:glyphid_gland");
