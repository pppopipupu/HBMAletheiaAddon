...
public class AletheiaBlocks {
    ...
    public static void init() {
        ...
        ams_base = new BlockAMSBase().setBlockName("ams_base").setHardness(5.0F).setResistance(10.0F).setBlockTextureName("hbm:block_steel");
        GameRegistry.registerBlock(ams_base, "ams_base");

        ams_emitter = new BlockAMSEmitter().setBlockName("ams_emitter").setHardness(5.0F).setResistance(10.0F).setBlockTextureName("hbm:block_steel");
        GameRegistry.registerBlock(ams_emitter, "ams_emitter");

        ams_limiter = new BlockAMSLimiter().setBlockName("ams_limiter").setHardness(5.0F).setResistance(10.0F).setBlockTextureName("hbm:block_steel");
