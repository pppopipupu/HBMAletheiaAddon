...
public class AletheiaRecipesNtmcProcessing {
    ...
    private static void registerSILEX() {
        try {
            ...
            map.put(new ComparableStack(ModItems.fluid_icon, 1, Fluids.REDMUD.getID()), new SILEXRecipes.SILEXRecipe(900, 150, EnumWavelengths.VISIBLE)
            ...
            for (int i = 0; i < 5; i++) {
                map.put(new ComparableStack(AletheiaItems.rbmk_pellet_rs1, 1, i), new SILEXRecipes.SILEXRecipe(600, 100, 1)
                ...
                map.put(new ComparableStack(AletheiaItems.rbmk_pellet_rs2, 1, i), new SILEXRecipes.SILEXRecipe(600, 100, 2)
    ...
    private static void registerShredder() {
        ShredderRecipes.setRecipe(new ComparableStack(AletheiaItems.fragment_neodymium), new ItemStack(AletheiaItems.powder_neodymium_tiny, 1));
    }

    private static void registerAnvil() {
        AnvilRecipes.constructionRecipes.add(new AnvilRecipes.AnvilConstructionRecipe(
            new ComparableStack(DictFrame.fromOne(ModItems.chunk_ore, EnumChunkType.RARE)),
            new AnvilRecipes.AnvilOutput[] {
                new AnvilRecipes.AnvilOutput(new ItemStack(ModItems.fragment_boron)),
                ...
                new AnvilRecipes.AnvilOutput(new ItemStack(ModItems.fragment_niobium), 0.5F)
            }
        ).setTier(2));
    }
}
