...
public class AletheiaRecipesNtmcElectrolysis {
    ...
    public static void register() {
        ...
        ElectrolyserFluidRecipes.recipes.put(Fluids.BRINE, new ElectrolysisRecipe(400, new FluidStack(Fluids.HYDROGEN, 200), new FluidStack(Fluids.OXYGEN, 200), 40, new ItemStack(AletheiaItems.powder_sodium, 2)));

        CentrifugeRecipes.recipes.put(
            new ComparableStack(ModItems.mineral_fragment, 1, 4),
            new ItemStack[] {
                new ItemStack(ModItems.powder_zirconium, 4),
                new ItemStack(AletheiaItems.powder_neodymium, 2),
        ...
        CentrifugeRecipes.recipes.put(
            ...
            new ItemStack[] {
                ...
                new ItemStack(ModItems.powder_nickel, 2),
                new ItemStack(AletheiaItems.powder_sodium, 1),
