...
import com.pppopipupu.aletheia.render.ModelZOMG;
...
public class ItemRenderPPPOP extends ItemRenderWeaponBase {
	...
	public void renderFirstPerson(ItemStack stack) {
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Aletheia.MODID + ":textures/models/ModelZOMG.png"));
		double scale = 0.75D;
