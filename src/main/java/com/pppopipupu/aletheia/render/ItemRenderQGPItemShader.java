...
public class ItemRenderQGPItemShader implements IItemRenderer {
        ...
        if (icon != null) {
            ...
            if (shader == null) {
                shader = new Shader(
                    ...
                    new ResourceLocation(Aletheia.MODID, "shaders/qgp_singularity.frag"));
            }

            shader.use();
            shader.setUniform1f("time", (System.currentTimeMillis() % 100000) / 1000.0F);
            shader.setUniform1i("state", 0);
