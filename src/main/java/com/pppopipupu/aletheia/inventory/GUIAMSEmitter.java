...
public class GUIAMSEmitter extends GuiInfoContainer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        Aletheia.MODID + ":textures/gui/gui_ams_emitter.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        emitter.coolant.renderTankInfo(this, mouseX, mouseY, guiLeft + 26, guiTop + 69 - 52, 16, 52);
        ...
        this.drawCustomInfo(
            ...
            16,
            52,
            new String[] { "Power:", emitter.efficiency + "%" });
        this.drawCustomInfo(
            this,
            mouseX,
            mouseY,
            ...
            16,
            52,
            new String[] { "Heat:", emitter.heat + "/" + emitter.maxHeat });
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        String name = this.emitter.hasCustomInventoryName() ? this.emitter.getInventoryName()
            : I18n.format(this.emitter.getInventoryName());
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        emitter.coolant.renderTank(guiLeft + 26, guiTop + 69, this.zLevel, 16, 52);
    }
}
