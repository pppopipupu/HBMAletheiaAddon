...
public class GUIAMSLimiter extends GuiInfoContainer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(
        Aletheia.MODID + ":textures/gui/gui_ams_limiter.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        limiter.coolant.renderTankInfo(this, mouseX, mouseY, guiLeft + 26, guiTop + 69 - 52, 16, 52);
        ...
        this.drawCustomInfo(
            ...
            16,
            52,
            new String[] { "Efficiency:", limiter.efficiency + "%" });
        this.drawCustomInfo(
            this,
            mouseX,
            mouseY,
            ...
            16,
            52,
            new String[] { "Heat:", limiter.heat + "/" + limiter.maxHeat });
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        String name = this.limiter.hasCustomInventoryName() ? this.limiter.getInventoryName()
            : I18n.format(this.limiter.getInventoryName());
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        int l = limiter.mode;
        if (l > 0) drawTexturedModalRect(guiLeft + 98, guiTop + 17, 176, 84 + 16 * l, 16, 16);

        int m = limiter.warning;
        if (m > 0) drawTexturedModalRect(guiLeft + 80, guiTop + 17, 176, 36 + 16 * m, 16, 16);

        limiter.coolant.renderTank(guiLeft + 26, guiTop + 69, this.zLevel, 16, 52);
    }
}
