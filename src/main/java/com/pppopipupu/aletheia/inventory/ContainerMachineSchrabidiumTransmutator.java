...
public class ContainerMachineSchrabidiumTransmutator extends Container {
    ...
    public ContainerMachineSchrabidiumTransmutator(InventoryPlayer invPlayer,
        TileEntityMachineSchrabidiumTransmutator te) {
        transmutator = te;

        this.addSlotToContainer(new Slot(te, 0, 44, 63));
        this.addSlotToContainer(new SlotCraftingOutput(invPlayer.player, te, 1, 134, 63));
        this.addSlotToContainer(new Slot(te, 2, 26, 18));
        this.addSlotToContainer(new Slot(te, 3, 8, 108));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index <= 3) {
                ...
                } else if (rStack.getItem() == ModItems.ingot_uranium) {
